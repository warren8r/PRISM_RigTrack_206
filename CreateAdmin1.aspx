<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateAdmin1.aspx.cs" Inherits="CreateAdmin" %>
                                        ...
                                        <table>
                                            ...
                                            <tr> 
                                                ...
                                                <td align="left" class="label_display">
                                                    ...
                                                    <telerik:RadTextBox ID="radtxt_zip" Width="160px" runat="server" ></telerik:RadTextBox>
                                                </td>
                                                <td align="left" class="label_display">
                                                    Phone<span class="star">*</span><br />
                                                    <telerik:RadTextBox ID="radtxt_phone" Width="160px" runat="server" ></telerik:RadTextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td align="left" class="label_display">
                                                    ...
                                                    <telerik:RadTextBox ID="radtxt_cellno" Width="160px" runat="server" ></telerik:RadTextBox>
                                                ...
                                                <td>
                                                    ...
                                                    <telerik:RadComboBox ID="radcombo_role" runat="server" Width="160px"  
                                                     DataSourceID="SqlDataSource2" DataTextField="UserType" DataValueField="UserTypeID"
                                                     />
                                                     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MDMConnectionString %>"
                                                          SelectCommand="SELECT [UserTypeID], [UserType] FROM [SuperUserType] ORDER BY [UserType]">
                                                     </asp:SqlDataSource>
                                                </td>
                                                <td></td>
                                            </tr>
