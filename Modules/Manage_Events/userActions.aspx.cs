...
public partial class Modules_Manage_Events_userActions : System.Web.UI.Page
{
    ...
    public void ConfigureExport()
    {
        ...
        //RadGrid1.ExportSettings.UseItemStyles = CheckBox4.Checked;
    }
    ...
    protected void ResetFilter1(object sender, EventArgs e)
    {
        ...
        //FlagList.Items.Add(new DropDownListItem("- Select Event -", "-1"));

        //ActionList.Items.Clear();
        //ActionList.Items.Add(new DropDownListItem("- Select Action -", "-1"));
