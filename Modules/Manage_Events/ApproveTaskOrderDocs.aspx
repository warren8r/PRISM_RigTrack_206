<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true" CodeFile="ApproveTaskOrderDocs.aspx.cs" Inherits="Modules_Manage_Events_ApproveTaskOrderDocs" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function OpenFileExplorerDialog(obj1, objeventamiid) {
            ...
            wnd.setUrl("../../ManageUserDocsbyAdmin.aspx?eventid=" + obj1 + "&eventamiid=" + objeventamiid + "");
            wnd.show();
...
<asp:UpdatePanel ID="up1" runat="server">
   ...
   <%-- // Jd New CSS Loading Animation--%>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
                        ...
                        <tr>
                            ...
                            <br />
                                <telerik:RadDropDownList ID="ActionList" runat="server" DataSourceID="UserActionList"
                                    DataTextField="actionName" DataValueField="id" AppendDataBoundItems="true"
                                    Width="150px" DropDownHeight="150px">
                                    <Items><telerik:DropDownListItem Text="-SELECT-" /></Items>
                                </telerik:RadDropDownList>
                            </td>
                            <td>
                            <br />
                                <telerik:RadDropDownList ID="FlagList" runat="server" DataSourceID="flags" DataTextField="flagName" AppendDataBoundItems="true"
                                    DataValueField="id"  Width="150px" DropDownHeight="150px">
                                <Items><telerik:DropDownListItem Text="-SELECT-" /></Items>
                                </telerik:RadDropDownList>
                            </td>
                            <td>
        ...
        <div>
            <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" GridLines="None"  DataSourceID="MasterTableData" AutoGenerateColumns="False"
            ...
            <Columns>
                    ...
                    <NestedViewTemplate>
                        <div class="input">
                            ...
                            <div class="input">
                                <asp:Button ID="ManageFilesBtn" runat="server" Text="Manage Task Orders" OnClientClick='<%# String.Format("OpenFileExplorerDialog({0},{1});return false;",Eval("eventcodeid"), Eval("eventamiid"))%> '>
                                </asp:Button></div>
                        </div>
                        <div class="input">
                            <span class="label"></span>
                        ...
                        <div class="input" style="float: left">
                            <span class="label"></span>
                            <div class="input">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="Save" CommandName="Update"></asp:Button>
                            </div>
                        </div>
...
<div id="dataSource">
        <asp:SqlDataSource ID="events" runat="server" 
            ...
            SelectCommand="SELECT eventName + ' ' + eventCode AS eventDetail, id FROM events ORDER BY eventDetail ASC"></asp:SqlDataSource>

        <asp:SqlDataSource ID="categories" runat="server" 
            ConnectionString="<%$ databaseExpression:client_database %>" 
            SelectCommand="SELECT [categoryName], [id] FROM [category] ORDER BY categoryName ASC"></asp:SqlDataSource>

        <asp:SqlDataSource ID="flags" runat="server" ConnectionString="<%$ databaseExpression:client_database %>" SelectCommand="SELECT [flagName], [id] FROM [flag] ORDER BY flagName ASC"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="MasterTableData" runat="server" connectionString="<%$ databaseExpression:client_database %>" 
                ...
                UpdateCommand = "UPDATE eventAMI SET userActionId = @userActionId WHERE id = @Event_Id">
            </asp:SqlDataSource>
        
        <asp:SqlDataSource ID="UserActionList" runat="server" 
            ConnectionString="<%$ databaseExpression:client_database %>" 
            ProviderName="System.Data.SqlClient" 
            SelectCommand="SELECT [actionName], [id] FROM [userAction] where role='admin' ORDER BY actionName ASC"></asp:SqlDataSource>
    </div>
    
    <telerik:RadAjaxLoadingPanel runat="server" ID="loader"></telerik:RadAjaxLoadingPanel>
    </ContentTemplate>
