    ...
    protected void grid_rig_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if ((e.Item.ItemType == GridItemType.Item) || (e.Item.ItemType == GridItemType.AlternatingItem))
        {
            ...
            if (dt_assetneeded.Rows.Count > 0)
            {
                ...
                string query = "select pa.[24HourActivity] as Activity,ph.Time as Timedet from PrismJobRun24HourActivityLog p,Prism24HourActivity pa,Prism24Hours ph where p.StartTime=ph.TimeId and p.[24HourActivity]=pa.HourActivityId and p.RunId=" + dt_assetneeded.Rows[0]["runid"].ToString() + "  order by p.StartTime Desc";
