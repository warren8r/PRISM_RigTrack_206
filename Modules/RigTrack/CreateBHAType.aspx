<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DialogMaster.master" AutoEventWireup="true" CodeFile="CreateBHAType.aspx.cs" Inherits="Modules_RigTrack_CreateBHAType" %>
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td valign="top">Enter BHA Type<br />
                    ...
                    <tr>
                        ...
                        <MasterTableView AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>               
                                ...
                                <telerik:GridBoundColumn DataField="BHAType" FilterControlAltText="Filter ServiceName column"
                                    HeaderText="BHAType" SortExpression="BHAType" UniqueName="BHAType">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="BHADesc"  FilterControlAltText="Filter BHADesc column"
                                    HeaderText="Description" SortExpression="BHADesc" UniqueName="BHADesc">
                                </telerik:GridBoundColumn>
                     ...
                     <asp:SqlDataSource ID="SqlServiceData" runat="server" ConnectionString="<%$ databaseExpression:client_database  %>"
                        SelectCommand="SELECT * FROM tblBHAType">
                    </asp:SqlDataSource>
                        </td>
                    </tr>
                </table>
