<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DialogMaster.master" AutoEventWireup="true" CodeFile="CreateToolManufacturer.aspx.cs" Inherits="Modules_RigTrack_CreateToolManufacturer" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td valign="top">Enter Manufacturer Name<br />
                    ...
                    <tr>
                     ...
                     <asp:SqlDataSource ID="SqlServiceData" runat="server" ConnectionString="<%$ databaseExpression:client_database  %>"
                        SelectCommand="SELECT * FROM [RigTrack].[tblCreateToolManufacturer]">
                    </asp:SqlDataSource>
                        </td>
                    </tr>
                </table>
