...
public partial class Modules_Configuration_Manager_CreateEditToolGroup : System.Web.UI.Page
{
    ...
    protected void btn_adddet_OnClick(object sender, EventArgs e)
    {
        ...
        // jd commented this out was the old success message
        //lbl_message.Text = "";
    }
    private void RememberSelected()
    {
        ...
        {
            CheckBox checkColumn = item.FindControl("chk_assets") as CheckBox;
    ...
    protected void btn_save_OnClick(object sender, EventArgs e)
    {
        ...
        if (btn_save.Text!="Update")
        {
            try
            {
               ...
               /// lbl_message.Text = "Record Saved Successfully";
                ...
                string script = "SuccessDialog(\" Record Saved Successfully \");";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "SavedRecord", script, true);
        ...
        else
        {
            try
            {
                ...
                string script = "SuccessDialog(\" Record Updated Successfully \");";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "UpdatedRecord", script, true);
    ...
    protected void lnk_viewedit_Click(object sender, EventArgs e)
    {
        ...
        if (dt_getexistkitnames.Rows.Count > 0)
        {
            ...
            DataTable dt_getexistkitnames_det = SqlHelper.ExecuteDataset(GlobalConnetionString.ClientConnection(), CommandType.Text, "select * from PrismKitAssetFromKitName k,PrismAssetName a,Prism_Assets c where c.ID=k.assetids and c.AssetName=a.Id and k.assetkitid=" + lbl_assetkitid.Text + "").Tables[0];
        ...
        if (dt_existassignedkit.Rows.Count > 0)
        {
            ...
            //lbl_messageforassigned.Text = "This Tool Group is already assigned to jobs, you can not update this Tool Group details";
            txt_kitname.Text = "";
            txt_kitdesc.Text = "";
            string script = "ErrorDialog(\" This Tool Group is already assigned to jobs, you can not update this Tool Group details \");";
    ...
    protected void radgrid_manageassetkits_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            DataTable dt_getexistkitnames_det = SqlHelper.ExecuteDataset(GlobalConnetionString.ClientConnection(), CommandType.Text,
                "select a.AssetName,c.SerialNumber,qty from PrismKitAssetFromKitName k,PrismAssetName a,Prism_Assets c where c.ID=k.assetids and c.AssetName=a.Id and k.assetkitid=" + lbl_assetkitid.Text + "").Tables[0];
    ...
    protected void btn_savenew_Click(object sender, EventArgs e)
    {
        lblmessagetop.Text = "";
         ...
         {
             lblmessagetop.Text = "Tool Group Name already exist";
