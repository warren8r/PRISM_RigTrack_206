...
public partial class Modules_RigTrack_ViewPreviousDailyRunReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString.Count > 0 && Request.QueryString["jobID"] != null)
            {
                radcombo_job.SelectedValue = Request.QueryString["jobID"].ToString();
