...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        ...
        function validationCheck()
        {
            ...
            var warevale = combowarehouse.get_value();
            
            if (combojob.get_value() == "0" && combowarehouse.get_value() == "") {
                //radalert('Please select Job/Warehouse', 330, 180, 'Client RadAlert');
                alert("Please select Job/Warehouse");
                return false;
            }
                ...
                <table width="600px">
                    <tr>
                        ...
                        <td style="font-weight:bold" id="jobdisplay"  runat="server">
                            Select Job:<br />
                            <telerik:RadComboBox runat="server" ID="combo_job" Width="220px" AppendDataBoundItems="true" OnClientSelectedIndexChanged="OnClientSelectedIndexChangedJob" DropDownHeight="220px">
                                                        <Items>
                        ...
                        <td id="viewbutton"  runat="server">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btn_viewinventory" runat="server" Text="View Inventory" OnClientClick="return validationCheck();" OnClick="btn_viewinventory_Click" />
                                    </td>
                                    <td>
