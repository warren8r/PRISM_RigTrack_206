<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/DialogMaster.master" AutoEventWireup="true" CodeFile="ViewDailyRunReport.aspx.cs" Inherits="Modules_Configuration_Manager_ViewDailyRunReport" %>
            ...
            <td align="center">
                <table>
                    <tr>
                        ...
                        <td align="left">
                            Select Job:<br />
                            <telerik:RadComboBox runat="server" ID="radcombo_job" Width="220px"  DropDownHeight="220px">
                                <Items>
                                    ...
                                    <td valign="top">
                                        <table id="Table1" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox1" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="td">Midnight Depth:</td>
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox2" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="td">Agitator In Use?:</td>
                                                <td class="tdv">
                                                    <telerik:RadComboBox ID="RadTextBox3" runat="server" Width="200px">
                                                        <Items>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox4" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                    </table>
                                        ...
                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox5" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="td">Amp Hrs Used Today (EM):</td>
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox6" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="td">Amp Hrs Remaining (EM):</td>
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox7" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox9" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                                <tr>
                                                <td class="td">Day End Volts: (Bat1):</td>
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox10" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                                 <tr>
                                                <td class="td">Day End Volts: (Bat2):</td>
                                                <td class="tdv"><telerik:RadTextBox ID="RadTextBox11" runat="server" Width="200px"></telerik:RadTextBox></td>
                                            </tr>
                                    </table>
                                        </td>
                                </tr>
                                  ...
                                  <tr>
                                      <td colspan="2">
                                          ...
                                          <telerik:RadGrid ID="radgrdMeterList" runat="server" CellSpacing="0" GridLines="None"
                                                 AllowFilteringByColumn="True" width="700px" Visible="false"
                                                      ...
                                                      <fieldset>
                                                          ...
                                                          <table>
                                                              ...
                                                              <tr>
                                                                  <td>Select&#160;Time:</td>
                                                                  <td>
                                                                      <telerik:RadComboBox ID="combo_time" runat="server" DataSourceID="SqlGet24Hours" DataTextField="Time" DataValueField="TimeId"></telerik:RadComboBox>
                                                                  </td>
                                                                  <td>Select&#160;Activity:</td>
                                                                  <td>
                                                                      <telerik:RadComboBox ID="combo_activity" runat="server"  DataSourceID="SqlGet24HourActivity" DataTextField="24HourActivity" DataValueField="HourActivityId">

                                                                      </telerik:RadComboBox><asp:LinkButton ID="LinkButton2" runat="server" Text="Create New"
                                                                         OnClientClick="openwinactivity();return false" />
                                                                  </td>
                                                              </tr>
                                                              <tr>
                                                                  <td>Comments:</td>
                                                                  <td colspan="3">
                                                                      <telerik:RadTextBox ID="txt_comments"  runat="server" TextMode="MultiLine" Width="500px"></telerik:RadTextBox>
                                                                  </td>
                                                              </tr>
                                                              <tr>
