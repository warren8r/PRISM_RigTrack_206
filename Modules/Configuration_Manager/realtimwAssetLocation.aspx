<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true"
    CodeFile="realtimwAssetLocation.aspx.cs" Debug="true" Inherits="Modules_Manage_Events_eventDashboard" %>
...
<telerik:RadScriptBlock ID="radsc" runat="server">
        <script type="text/javascript">
            ...
            function moveselectedassets() {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://67.40.65.182:999/realtimeassetloctable.aspx/moveselectedassets",
                    ...
                    success: function (data) {
                        ...
                        if (data.d == "success") {
                            alert("Selected Assets are moved to current location");
                        }
            ...
            function getAssetIDS(obj) {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://67.40.65.182:999/realtimeassetloctable.aspx/getHTML_new",
            ...
            function validationforasset() {
                ...
                var text = combo.get_text();
                if (text == "-Select-" || text == "") {
                    radalert('Please Select Asset Status', 330, 180, 'Alert Box', null, null);
                    return false;
            ...
            function validationforassetno() {
                ...
                if (text == "") {
                    radalert('Please Enter Asset Serial no.', 330, 180, 'Alert Box', null, null);
                    return false;
            ...
            function validationforlocation() {
                ...
                var text = combo.get_text();
                if (text == "Select Asset Category" || text == "") {
                    radalert('Please Select Asset Category', 330, 180, 'Alert Box', null, null);
                    return false;
                ...
                if (text == "Please Select Asset(s)" || text == "") {
                    radalert('Please Select Asset', 330, 180, 'Alert Box', null, null);
                    return false;
            ...
            <div style="position: fixed; text-align: center; height: 100%; width: 100%; top: 0; right: 0; left: 0; padding-top: 15%; z-index: 9999999;">
                ...
                <asp:SqlDataSource ID="SqlGetAssetCategory" ConnectionString="<%$ databaseExpression:client_database %>"  runat="server"
                  SelectCommand="select clientAssetID, clientAssetName from clientAssets  where active='True'"></asp:SqlDataSource>
                                                    ...
                                                    <td align="left">
                                                        Select Asset:<br />
                                                        <telerik:RadComboBox runat="server" ID="combo_assetsTop" CheckBoxes="true"  Width="300px" EmptyMessage="Please Select Asset(s)" DataTextField="AssetName" 
...
from manageJobOrders where  status!='Closed' and (jid in (select jobid from PrismJobAssignedAssets) and 
jid in (select jobid from PrismJobAssignedPersonals)) and jobordercreatedid<>'' "></asp:SqlDataSource>
                                ...
                                <telerik:RadWindow ID="RadWindow_ContentTemplate" runat="server"  Width="600px"
                                    ...
                                    <ContentTemplate>
                                        <table>
                                            ...
                                            <tr><td  style="font-size:13px;font-weight:bold">Are you sure you want to move the following selected Assets:</td></tr>
