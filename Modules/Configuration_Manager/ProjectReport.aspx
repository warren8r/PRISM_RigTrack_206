<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true" CodeFile="ProjectReport.aspx.cs" Inherits="Modules_Configuration_Manager_ProjectReport" %>
                            ...
                            <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" GridLines="None" AllowPaging="True"
                                ...
                                <MasterTableView>
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn   HeaderText="Asset Name / Qty. Required"   FilterControlAltText="Filter projectManager column"  HeaderStyle-HorizontalAlign="Center"
                                        SortExpression="AssetsRequired" UniqueName="AssetsRequired">
                                            <ItemTemplate>
                                             <telerik:RadGrid ID="radgridAssetsRequired" runat="server" HeaderStyle-Width="150" ItemStyle-Width="150" ShowHeader="false" AutoGenerateColumns="true">
                                                <MasterTableView NoDetailRecordsText="Additional Assets Not Required" NoMasterRecordsText="No Additional Assets Required"></MasterTableView>
                                           </telerik:RadGrid>
                                            </ItemTemplate>                               
                                        </telerik:GridTemplateColumn>
