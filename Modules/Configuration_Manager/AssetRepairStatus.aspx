<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true" CodeFile="AssetRepairStatus.aspx.cs" Inherits="Modules_Configuration_Manager_AssetRepairStatus" %>
                                    ...
                                    <td align="left">
                                        ...
                                        <telerik:RadComboBox runat="server" ID="combo_job"  DataSourceID="SqlGetJobs" DataTextField="jobname" DataValueField="jid"  EmptyMessage="Select JobName" Width="200px"
                                            ...
                                            <asp:SqlDataSource ID="SqlGetJobs" ConnectionString="<%$ databaseExpression:client_database %>"  runat="server" 
                                             SelectCommand="select [jid],jobname + ' ('+jobordercreatedid+')' as Jobname from manageJobOrders where status!='Closed' and (jid in (select jobid from PrismJobAssignedAssets) or jid in (select jobid from PrismJobAssignedPersonals)) and jobordercreatedid<>''"></asp:SqlDataSource>
                                    </td>
                                    <td>
                                        <br />
                                        <asp:Button ID="btn_jobview" runat="server" Text="View" OnClick="btn_jobview_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Condition" >
                                ...
                                <ItemTemplate >
                                    ...
                                    <asp:Label ID="lbl_statuscheck" runat="server" Text='<%# Bind("repairstatus") %>'></asp:Label>
                                    <asp:Label ID="lbl_assetid" runat="server" Text='<%# Bind("Id") %>' Visible="false" ></asp:Label>
                            ...
                            <telerik:GridBoundColumn DataField="DailyCharge" AllowFiltering="false" FilterControlAltText="Filter meterType column"
                                HeaderText="Daily Charge($)" SortExpression="DailyCharge" UniqueName="DailyCharge">
