<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true"
    Trace="false" CodeFile="ManageCustomers.aspx.cs" Inherits="Modules_Configuration_Manager_SDP" Debug="true" %>
<%@ Register TagPrefix="MDM" TagName="Customer" Src="~/Controls/configMangrSDP/mngCutomer.ascx" %>
