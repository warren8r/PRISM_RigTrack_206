<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComponentsNotes.aspx.cs" Inherits="Modules_Configuration_Manager_ComponentsNotes" %>
    ...
    <asp:UpdateProgress ID="loader" runat="server" DisplayAfter="0">
        ...
        <table style="font-family:Verdana;font-size:10px">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server"  ConnectionString="<%$ databaseExpression:client_database %>" 
             SelectCommand="SELECT (u.firstname+' '+u.lastname) as name,* FROM MainteneceNotes m,Users u,UserRoles r where m.UserId=u.userID and r.userRoleID=u.userRoleID and ComponentMainteneceId=@assetridid and AssetMainteneceId is null" >
