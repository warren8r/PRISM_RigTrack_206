...
public partial class createjobtypes : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            hidd_assetridid.Value = Request.QueryString["Assetid"].ToString();
    ...
    protected void btn_crtjob_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string str_jobtype_insert = "insert into MainteneceNotes(AssetMainteneceId,Notes,UserId,Datetime)values('" + hidd_assetridid.Value + "','" + radtxt_jobdesc.Text + "','" + Session["UserId"] + "','" + DateTime.Now +"')";
            tran.Commit();
        }
        catch (Exception ex)
        {
