...
public partial class Modules_Configuration_Manager_SDP : System.Web.UI.Page
{
    ...
    /// Author: Jason Burton, Fortech Energy, Inc.
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RadTabStrip1.Tabs[0].Text = constant.ReturnConstant(3).ToString() + "s";
        RadTabStrip1.Tabs[1].Text = constant.ReturnConstant(4).ToString() + "s";
