<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true"
    CodeFile="confMngrSetAssetLabels.aspx.cs" Inherits="Modules_Configuration_Manager_confMngrSetAssetLabels" %>
...
-->
    <div style="margin-left: 25px;">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="200px" Width="300px">
            ...
            <asp:Panel ID="panEditAsset" runat="server" Visible="false" style="margin-bottom: 20px;" width="500px" >
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="chkEditActive" runat="server" Width="20px" ToolTip="Active/In-Active" TextAlign="Right"
                                AutoPostBack="true" oncheckedchanged="chkEditActive_CheckedChanged" />
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="5">
                            <asp:Button ID="btnSaveAssetName" runat="server"
                                Text="Save" ToolTip="Save changes" ValidationGroup="EditValidationGroup"
            ...
            <asp:SqlDataSource ID="sqlClientAssetsUpdate" runat="server" ConnectionString="<%$ databaseExpression:client_database  %>"
                UpdateCommand="UPDATE clientAssets SET [clientAssetName] = @ClientAssetName, [active] = @Active, [rank] = @Rank WHERE ([clientAssetID] = @ClientAssetID)"
                OnUpdated="sqlClientAssets_Updated" 
                SelectCommand="SELECT clientAssetID, clientAssetName, ISNULL(active, 'false') AS active, ISNULL(rank, 0) AS rank FROM clientAssets WHERE (clientAssetID = @ID)">
                <SelectParameters>
                ...
                <UpdateParameters>
                    ...
                    <asp:ControlParameter ControlID="radtxtEditRank" Name="Rank" 
            ...
            <telerik:RadGrid ID="radgrdAssetNames" runat="server" CellSpacing="0" Width="390px"
                ...
                <MasterTableView DataKeyNames="clientAssetID" DataSourceID="sqlClientAssetsList" ToolTip="Asset Categories">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="rank" 
    ...
    <asp:SqlDataSource ID="sqlClientAssetsList" runat="server" ConnectionString="<%$ databaseExpression:client_database  %>"
        SelectCommand="SELECT [clientAssetID] AS [clientAssetID], [clientAssetName] AS [clientAssetName], ISNULL(active, 'false') AS [active], [rank] AS [rank] 
                       FROM clientAssets ORDER BY ISNULL([rank], 9999), [clientAssetName]"
