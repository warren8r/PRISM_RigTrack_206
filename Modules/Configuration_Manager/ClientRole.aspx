...
<style type="text/css">
                    ...
                    <tr>
                        <td align="center">
                            <table>
                                <tr>
                                    <td>
                                        <fieldset class="register" style="display: inline-block;width: 960px;" >
 ...
 events LEFT OUTER JOIN flag ON events.flagId = flag.id and events.eventnotification='True' ORDER BY eventName ASC"></asp:SqlDataSource>
                                     </fieldset>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table>
                                    ...
                                    <td>
                                        <fieldset class="register" style="display: inline-block;">
                                            ...
                                            <telerik:RadGrid ShowGroupPanel="true" AutoGenerateColumns="false" ID="grid_roleaccess"
                                                ...
                                                ShowFooter="false" runat="server" GridLines="None" AllowPaging="true" OnItemCommand="grid_roleaccess_ItemCommand"
                                ...
                                <Selecting AllowRowSelect="true" />
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1"
                                             SelectCommand="select * from UserRoles ur left outer join Modules m on ur.userRoleID=m.moduleID WHERE m.parentId = '0' 
                                              order by m.moduleID"
