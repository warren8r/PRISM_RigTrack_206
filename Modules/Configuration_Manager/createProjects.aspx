<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/RigTrack.master" AutoEventWireup="true" CodeFile="createProjects.aspx.cs" Inherits="Modules_Configuration_Manager_assetsCreatejobOrder" %>
            ...
            <td align="left">
                <table border="0">
                    <tr>
                        ...
                        <td>
                            Job Type: (<asp:LinkButton ID="LinkButton2" ForeColor="Blue" runat="server" OnClientClick="togglePopupModality(); return false;">Create New</asp:LinkButton>)<br />
                         ...
                         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ databaseExpression:client_database %>"
                            ...
                            <Windows>
                                   <telerik:RadWindow ID="RadWindow_ContentTemplate" runat="server"  Width="400px"
                                        Height="400px" NavigateUrl="~/createjobtypes.aspx" OnClientClose="OnPopupClosed" >
                        ...
                        <td>
                            Rig Name:<br />
                            <telerik:RadComboBox ID="radcombo_rigtype" runat="server"  EmptyMessage="- Select -" DataSourceID="sqlGetRignamesnotinjoborder" DataTextField="rigtypename" DataValueField="rigtypeid"></telerik:RadComboBox>
                            ...
                            <Windows>
                                   <telerik:RadWindow ID="RadWindow2" runat="server"  Width="400px"
                                        Height="400px" NavigateUrl="~/createRigTypes.aspx" OnClientClose="OnPopupClosed">
                         ...
                         <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ databaseExpression:client_database %>"
                                    SelectCommand="SELECT * FROM [RigTypes]"></asp:SqlDataSource>
                                     <asp:SqlDataSource ID="sqlGetRignamesnotinjoborder" runat="server" ConnectionString="<%$ databaseExpression:client_database %>"
                                    SelectCommand="SELECT * FROM [RigTypes]  where rigtypeid not in (select rigtypeid from managejoborders where status='Approved')"></asp:SqlDataSource>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <telerik:RadComboBox ID="radcombo_pmanager" runat="server" DataSourceID="SqlDataSource5" DataTextField="Name" DataValueField="userID" EmptyMessage="- Select -"></telerik:RadComboBox>
                            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ databaseExpression:client_database %>"
