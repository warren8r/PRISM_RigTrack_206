<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="NewClientRegistration.aspx.cs" Inherits="NewClientRegistration" %>
                                                      ...
                                                      <%--   <tr>
                                                                ...
                                                                <td valign="top">
                                                                    <telerik:RadTextBox ID="txtPrimaryGIS" runat="server" 
                                                                                        ...
                                                                                        style="padding:0px;" Text='<%# Bind("primaryLatLong") %>' Width="120px" />
                                                                </td>                                                               
                                                                <td>
                                    ...
                                    <legend>Account Information</legend>
                                        <table>
                                            <tr> 
                                                ...
                                                <td></td><td><span id="CustomIndicator">&nbsp;</span> <span id="PasswordRepeatedIndicator" class="Base L0">&nbsp;</span></td>
                                            </tr>
