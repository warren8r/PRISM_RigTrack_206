...
using System.Data;
public partial class SuperAdminRegistration : System.Web.UI.Page
{
    ...
    public String insertUserDetails(UserMaster userMaster)
    {
        ...
        string insertSql = "insert into SuperUsers (userRoleID,firstName,lastName,title,loginName,email,address," +
            "address2,city,state,country,zip,phone,lastUpdatedDate,cellNo,activationCode,activationExpiry,createDate)values(" +
